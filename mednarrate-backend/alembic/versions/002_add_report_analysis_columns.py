...
def upgrade() -> None:
    ...
    op.add_column(
        "report_analyses", sa.Column("clinician_summary", sa.Text(), nullable=True)
    )
    op.add_column(
        "report_analyses", sa.Column("patient_summary", sa.Text(), nullable=True)
    )
    op.add_column(
        "report_analyses", sa.Column("error_reason", sa.Text(), nullable=True)
    )
    op.add_column(
        "report_analyses",
        sa.Column(
