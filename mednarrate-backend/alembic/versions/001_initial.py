...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "role", sa.Enum("patient", "clinician", name="userrole"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "file_type", sa.Enum("pdf", "image", name="filetype"), nullable=False
        ),
        sa.Column(
            "report_type",
            sa.Enum("blood", "pathology", "health", "other", name="reporttype"),
            nullable=False,
        ),
