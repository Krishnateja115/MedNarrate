...
def upgrade() -> None:
    ...
    with op.batch_alter_table("help_articles", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_help_articles_category"), ["category"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_help_articles_slug"), ["slug"], unique=True
        )
    ...
    op.create_table(
        ...
        sa.Column(
            "priority",
            sa.Enum("p1", "p2", "p3", "p4", name="ticketpriority"),
            nullable=False,
        ),
        sa.Column(
            "status",
        ...
        sa.ForeignKeyConstraint(
            ["related_incident_id"], ["incidents.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["related_report_id"], ["reports.id"], ondelete="SET NULL"
        ),
    ...
    with op.batch_alter_table("report_analyses", schema=None) as batch_op:
        ...
        batch_op.alter_column(
            "structured_lab_values", existing_type=sqlite.JSON(), nullable=False
        )
        batch_op.alter_column("entities", existing_type=sqlite.JSON(), nullable=False)
        batch_op.alter_column(
            "abnormal_findings", existing_type=sqlite.JSON(), nullable=False
        )
        batch_op.alter_column(
            "model_versions", existing_type=sqlite.JSON(), nullable=False
        )
...
def downgrade() -> None:
    ...
    with op.batch_alter_table("report_analyses", schema=None) as batch_op:
        batch_op.alter_column(
            "model_versions", existing_type=sqlite.JSON(), nullable=True
        )
        batch_op.alter_column(
            "abnormal_findings", existing_type=sqlite.JSON(), nullable=True
        )
        batch_op.alter_column("entities", existing_type=sqlite.JSON(), nullable=True)
        batch_op.alter_column(
            "structured_lab_values", existing_type=sqlite.JSON(), nullable=True
        )
        batch_op.alter_column(
            "report_id",
            existing_type=sa.Uuid(),
