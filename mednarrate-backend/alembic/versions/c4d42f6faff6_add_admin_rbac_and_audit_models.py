...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_admin_permissions_name"), "admin_permissions", ["name"], unique=True
    )
    ...
    op.create_index(
        op.f("ix_admin_role_assignments_role_id"),
        "admin_role_assignments",
        ["role_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_admin_role_assignments_user_id"),
        "admin_role_assignments",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_admin_audit_logs_actor_admin_id"),
        "admin_audit_logs",
        ["actor_admin_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_admin_audit_logs_timestamp"),
        "admin_audit_logs",
        ["timestamp"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_sensitive_access_grants_admin_id"),
        "sensitive_access_grants",
        ["admin_id"],
        unique=False,
    )
