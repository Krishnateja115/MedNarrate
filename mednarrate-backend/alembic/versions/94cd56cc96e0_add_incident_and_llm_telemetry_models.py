...
def upgrade() -> None:
    op.create_table('incidents',
        ...
        sa.Column('status', sa.Enum('open', 'investigating', 'identified', 'resolved', 'closed', name='incidentstatus'), nullable=False),
    ...
    op.create_table('llm_diagnostic_events',
        sa.Column('id', sa.UUID(as_uuid=True), nullable=False),
    ...
    op.create_index(op.f('ix_llm_diagnostic_events_provider'), 'llm_diagnostic_events', ['provider'], unique=False)
    op.create_index(op.f('ix_llm_diagnostic_events_request_id'), 'llm_diagnostic_events', ['request_id'], unique=False)
    op.create_index(op.f('ix_llm_diagnostic_events_timestamp'), 'llm_diagnostic_events', ['timestamp'], unique=False)
