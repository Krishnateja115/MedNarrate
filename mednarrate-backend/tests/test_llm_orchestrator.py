...
from app.services.llm_orchestrator import generate_primary_reasoning, verify_medical_facts, extract_structured_json, translate_text_indic
...
async def test_extract_structured_json_fallback(mock_generate):
    ...
    settings.STRUCTURED_MODEL_PROVIDER = "gemini" # not ollama, so it falls back to primary
