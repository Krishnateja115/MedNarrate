...
def test_case_a_valid_full():
    prof = MedicalProfileBase(
        blood_group="O+", known_allergies="Penicillin", chronic_conditions="Asthma"
    )
...
def test_case_b_valid_none():
    prof = MedicalProfileBase(
        blood_group="a+", known_allergies="None", chronic_conditions="None"
    )
...
def test_case_d_empty_blood_group():
    prof = MedicalProfileBase(
        blood_group="", known_allergies="Penicillin", chronic_conditions="Asthma"
    )
...
def test_case_e_empty_allergies_and_conditions():
    prof = MedicalProfileBase(
        blood_group="O+", known_allergies="", chronic_conditions=None
    )
    assert prof.blood_group == "O+"
