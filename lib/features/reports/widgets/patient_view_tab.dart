        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                _buildDoctorBullet(context, 'Review any out-of-range lab results with your healthcare provider.'),
                _buildDoctorBullet(context, 'Confirm dosage and frequency of all medications mentioned in this report.'),
                _buildDoctorBullet(context, 'Ask if follow-up testing or baseline comparisons are recommended.'),
              ],
            ),
          ),
